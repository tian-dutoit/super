...
var compareUrl = 'http://localhost:3000/api/v1/compare';
...
function postList(data, callback) {
  _superagent2.default.post(compareUrl).set('Content-Type', 'application/json').send(data).then(callback);
}
...
var _Compare = __webpack_require__(50);
...
var _Countdown = __webpack_require__(51);

var _Countdown2 = _interopRequireDefault(_Countdown);

var _NewWorld = __webpack_require__(58);

var _NewWorld2 = _interopRequireDefault(_NewWorld);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { to: '/compare' },
            ' ',
            _react2.default.createElement('input', { type: 'button', value: 'Press me', onClick: this.props.handlePress })
          )
        )
      );
    }
